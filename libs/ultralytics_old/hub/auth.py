...
from libs.ultralytics_old.hub.utils import HUB_API_ROOT, PREFIX, request_with_credentials
from libs.ultralytics_old.yolo.utils import LOGGER, SETTINGS, emojis, is_colab, set_settings
