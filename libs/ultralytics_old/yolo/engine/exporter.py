...
Requirements:
    $ pip install libs.ultralytics_old[export]

Python:
    from libs.ultralytics_old import YOLO
...
from libs.ultralytics_old.nn.autobackend import check_class_names
from libs.ultralytics_old.nn.modules import C2f, Detect, Segment
from libs.ultralytics_old.nn.tasks import DetectionModel, SegmentationModel
from libs.ultralytics_old.yolo.cfg import get_cfg
from libs.ultralytics_old.yolo.utils import (DEFAULT_CFG, LINUX, LOGGER, MACOS, __version__, callbacks, colorstr,
                                             get_default_args, yaml_save)
from libs.ultralytics_old.yolo.utils.checks import check_imgsz, check_requirements, check_version
from libs.ultralytics_old.yolo.utils.files import file_size
from libs.ultralytics_old.yolo.utils.ops import Profile
from libs.ultralytics_old.yolo.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        description = f'libs.ultralytics_old {self.pretty_name} model {trained_on}'
        self.metadata = {
            'description': description,
            'author': 'libs.ultralytics_old',
            'license': 'AGPL-3.0 https://libs.ultralytics.com/license',
            'version': __version__,
    ...
    def export_edgetpu(self, tflite_model='', prefix=colorstr('Edge TPU:')):
        ...
        LOGGER.warning(f'{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/libs.ultralytics/libs.ultralytics/issues/1185')
...
class iOSDetectModel(torch.nn.Module):
    """Wrap an libs.ultralytics_old YOLO model for iOS export."""
