...
from libs.ultralytics_old.yolo.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, ROOT, SETTINGS_YAML, clean_url, colorstr, emojis,
                                             yaml_load)
from libs.ultralytics_old.yolo.utils.checks import check_file, check_font, is_ascii
from libs.ultralytics_old.yolo.utils.downloads import download, safe_download, unzip_file
from libs.ultralytics_old.yolo.utils.ops import segments2boxes
...
class HUBDatasetStats():
    ...
    Usage
        from ultralytics_old.yolo.data.utils import HUBDatasetStats
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Usage:
        from pathlib import Path
        from ultralytics_old.yolo.data.utils import compress_one_image
...
def delete_dsstore(path):
    ...
    Usage:
        from ultralytics_old.yolo.data.utils import delete_dsstore
...
def zip_directory(dir, use_zipfile_library=True):
    ...
    Usage:
        from ultralytics_old.yolo.data.utils import zip_directory
