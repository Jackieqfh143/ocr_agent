...
from libs.ultralytics_old.yolo.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, TQDM_BAR_FORMAT, is_colab, is_dir_writeable,
                                             is_kaggle)
from libs.ultralytics_old.yolo.utils.checks import check_requirements
from libs.ultralytics_old.yolo.utils.ops import clean_str, segments2boxes, xyn2xy, xywh2xyxy, xywhn2xyxy, xyxy2xywhn
...
# Parameters
HELP_URL = 'See https://docs.libs.ultralytics.com/yolov5/tutorials/train_custom_data'
...
class LoadImages:
    ...
    def _new_video(self, path):
        ...
        # self.cap.set(cv2.CAP_PROP_ORIENTATION_AUTO, 0)  # disable https://github.com/libs.ultralytics/yolov5/issues/8493
