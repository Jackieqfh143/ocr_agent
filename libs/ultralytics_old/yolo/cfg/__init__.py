...
from libs.ultralytics_old.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_PATH, LOGGER, ROOT, USER_CONFIG_DIR,
...
def entrypoint(debug=''):
    """
    This function is the ultralytics_old package entrypoint, it's responsible for parsing the command line arguments passed
    to the package.
