...
from libs.ultralytics_old.yolo.utils import LOGGER, checks, clean_url, emojis, is_online, url2file
            ...
            try:
                if curl or i > 0:  # curl download with retry, continue
                    ...
                    if method == 'torch':
                        ...
                        from libs.ultralytics_old.yolo.utils import TQDM_BAR_FORMAT
...
def attempt_download_asset(file, repo='ultralytics_old/assets', release='v0.0.0'):
    """Attempt file download from GitHub release assets if not found locally. release = 'latest', 'v6.2', etc."""
    from libs.ultralytics_old.yolo.utils import SETTINGS  # scoped for circular import
