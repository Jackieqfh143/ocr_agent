...
from libs.ultralytics_old.yolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, __version__
...
def strip_optimizer(f: Union[str, Path] = 'best.pt', s: str = '') -> None:
    ...
    Usage:
        from pathlib import Path
        from ultralytics_old.yolo.utils.torch_utils import strip_optimizer
