...
Usage - Predict:
    from libs.ultralytics_old import NAS

    model = NAS('yolo_nas_s')
    results = model.predict('libs.ultralytics_old/assets/bus.jpg')
"""
...
from libs.ultralytics_old.yolo.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, ROOT, is_git_dir
