...
from libs.ultralytics_old.nn.tasks import RTDETRDetectionModel
from libs.ultralytics_old.yolo.utils import DEFAULT_CFG, RANK, colorstr
from libs.ultralytics_old.yolo.v8.detect import DetectionTrainer
