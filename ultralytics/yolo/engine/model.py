...
class YOLO:
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[ultralytics_old.yolo.engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(ultralytics_old.yolo.engine.results.Results): The prediction results.
    """
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        is_cli = (sys.argv[0].endswith('yolo') or sys.argv[0].endswith('ultralytics_old')) and any(
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        Returns:
            (List[ultralytics_old.yolo.engine.results.Results]): The tracking results.
